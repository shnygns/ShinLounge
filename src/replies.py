...
format_strs = {
	...
	types.ERR_ACTIVE_ELSEWHERE: em("Users can only be in one lounge at a time. To join here, leave <strong>{lounge}</strong> first, and wait for the system to update."),
